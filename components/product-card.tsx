  ...
  return (
    <Link href={`/product/${product.slug}`}>
      <div className="group relative bg-card rounded-xl overflow-hidden border border-border hover:border-primary transition-all duration-500 h-full flex flex-col shadow-lg hover:shadow-2xl hover:shadow-primary/30 hover:-translate-y-3">
        ...
        {/* Content Container */}
        <div className="flex-1 p-6 flex flex-col bg-gradient-to-br from-card to-card/80 relative z-10">
          {/* Category Badge */}
          ...
          <div className="flex items-center gap-2 mt-auto pt-4 border-t border-border/50">
            <button
              ...
              className={`flex-1 flex items-center justify-center gap-2 px-4 py-3 rounded-lg font-black text-sm uppercase tracking-wider transition-all duration-300 ${
                isAdded
            ...
            <button className="p-3 rounded-lg border border-border hover:border-secondary hover:bg-secondary/10 transition-all duration-300 group/heart">
